    ...
    <div className={style.main}>
      <div className={style.section}>
        ...
        <div className={style.subSection}>
          ...
          <p className={style.desc}>
            Computer Science and Engineering Club (CSEC) is Habib University’s
            leading student-led club, providing students with a platform to
            become potent contributors to Pakistan’s Science and Research output
            by harmonizing scientific research within the university,
            facilitating the student body in their research, streamlining and
            synchronizing research content and facilities by disambiguation and
            reduction of the divide between different branches of science.
          </p>
        </div>
      </div>
